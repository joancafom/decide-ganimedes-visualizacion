...
class VotingTestCase(BaseTestCase):
    ...
    def test_automatic_number_assignment_of_question_and_questionoption(self):
        ...
        self.assertEqual(q2opts[0].number, 1)
        self.assertEqual(q2opts[1].number, 2)
        self.assertEqual(q2opts[2].number, 3)
        
        q3 = questions[2]
        q3opts = list(q3.options.all())
        
        self.assertEqual(q3.number, 3)
        self.assertEqual(q3opts[0].number, 1)
        self.assertEqual(q3opts[1].number, 2)
        self.assertEqual(q3opts[2].number, 3)